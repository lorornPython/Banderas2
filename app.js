...
function App() {
  ...
  var _useState5 = useState([]),
    ...
    setDifficulties = _useState6[1]; // ✅ array de niveles
  var _useState7 = useState([]),
    _useState8 = _slicedToArray(_useState7, 2),
    regions = _useState8[0],
    setRegions = _useState8[1]; // ✅ array de regiones
  var _useState9 = useState([]),
    _useState0 = _slicedToArray(_useState9, 2),
    features = _useState0[0],
    setFeatures = _useState0[1]; // ✅ array de características
  ...
  function startGame() {
    ...
    var pool = filterPool(difficulties, regions, features).filter(function (f) {
  ...
  function iniciarFase(index) {
    ...
    setPhaseCorrects(0);
    // Forzamos dificultad de esa fase
    setDifficulties([fase.dificultad]);
    startGame({
  ...
  }, "Nota: la lista actual incluye ", /*#__PURE__*/React.createElement("strong", null, flags.length), " pa\xEDses."))));
}
