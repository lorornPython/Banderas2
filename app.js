...
/* Frases de "Nivel" con tono gamer/flags (Fortnite-like) */
var frasesNivel = {
...
function App() {
  ...
  // Progresivo (4 fases internas; barra general 10 niveles)
  var fases = [{
    dificultad: 1,
    numPreguntas: 5,
    minAciertos: 3,
  ...
  useEffect(function () {
    ...
    if (!currentQ) return; // Fallback seguro "Cargando..."
  ...
  function handleAnswer(choice) {
    ...
    // Avance automático en competición con delays solicitados
    if (gameMode === "progressive") {
  ...
  // Para cabecera: evitar mostrar "null" en training
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "Nota: pega tu lista local en ", /*#__PURE__*/React.createElement("strong", null, "const flags"), " para ver el total de pa\xEDses.")), stage === "game" && (current ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    ...
    className: "".concat(gameMode === "progressive" ? "hidden sm:block" : "", " text-sm text-slate-500 mb-4")
