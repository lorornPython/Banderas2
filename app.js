...
// ⚠️ Aquí va la lista completa de banderas del archivo estable
var flags = [
// Pega aquí la lista completa de banderas
// 🌍 EUROPA (44 países)
{
  name: "Albania",
  code: "al",
...
function App() {
  ...
  // --- funciones de startGame, iniciarFase, etc. idénticas al estable ---
  // Solo tocaremos handleAnswer, nextQuestion, saveScore.
