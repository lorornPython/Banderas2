...
function App() {
  ...
  var _useState5 = useState([]),
    ...
    setDifficulties = _useState6[1]; // array
  var _useState7 = useState([]),
    _useState8 = _slicedToArray(_useState7, 2),
    regions = _useState8[0],
    setRegions = _useState8[1]; // array
  var _useState9 = useState([]),
    _useState0 = _slicedToArray(_useState9, 2),
    features = _useState0[0],
    setFeatures = _useState0[1]; // array
  ...
  function startGame() {
    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      _ref$forceDifficultie = _ref.forceDifficulties,
      forceDifficulties = _ref$forceDifficultie === void 0 ? null : _ref$forceDifficultie,
      _ref$forceRegions = _ref.forceRegions,
      forceRegions = _ref$forceRegions === void 0 ? null : _ref$forceRegions,
  ...
  }, "Nota: la lista actual incluye ", /*#__PURE__*/React.createElement("strong", null, flags.length), " pa\xEDses.")), stage === "game" && (current ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    className: "flex items-center justify-between mb-4"
  }, /*#__PURE__*/React.createElement("div", {
    className: "text-xs sm:text-sm text-slate-600"
  }, "P: ", /*#__PURE__*/React.createElement("strong", null, score), " | T: ", tiempoRestante, "s | ", currentIndex + 1, "/", questions.length)), /*#__PURE__*/React.createElement("div", {
