...
// Frases estilo Fortnite
var frasesNivel = {
  1: "Recluta de Banderas 🏳️",
  2: "Explorador Tryhard 🌍",
  3: "Coleccionista Pro 📚",
  4: "Guerrero de Banderas ⚔️",
  5: "Épico Dominador 🔥",
  6: "Legendario 🌟",
  7: "Master Flagger 👑",
  8: "Ultra Tryhard ⚡",
  9: "Mythic Bannerlord 🐉",
  10: "God Tier de las Banderas 🏆"
};
function phraseForLevel(n) {
  var x = Math.max(0, Math.min(TOTAL_LEVELS, Number(n || 0)));
  return frasesNivel[x] || "—";
}
...
function SegmentedBar(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    if (i < filled) bg = levelColors[i % levelColors.length];else if (highlightNext && i === filled) bg = "#facc15"; // amarillo brillante
    return /*#__PURE__*/React.createElement("div", {
      key: i,
      style: {
        backgroundColor: bg
...
function App() {
  ...
  function filterPool() {
    ...
    var pool = flags;
    if (difficultiesArg.length > 0) pool = pool.filter(function (f) {
      return difficultiesArg.includes(f.difficulty);
    });
    if (regionsArg.length > 0) pool = pool.filter(function (f) {
  ...
  function startGame() {
    ...
    var pool = filterPool(forceDifficulties !== null && forceDifficulties !== void 0 ? forceDifficulties : difficulties, forceRegions !== null && forceRegions !== void 0 ? forceRegions : regions, features);
    pool = pool.filter(function (f) {
      return !usedFlagsRef.current.has(f.name);
    });
    if (pool.length === 0) {
      alert("No hay banderas que cumplan esos filtros.");
      return;
    }
    var selected = sample(pool, Math.min(effNum, pool.length));
    if (gameMode === "progressive") selected.forEach(function (f) {
  ...
  function startProgressiveGame() {
    if (bgMusicRef.current) bgMusicRef.current.play()["catch"](function () {});
  ...
  function iniciarFase(i) {
    ...
    var t = setInterval(function () {
      return setTiempoRestante(function (p) {
        return p > 0 ? p - 1 : 0;
      });
    }, 1000);
    setTimer(t);
  ...
  useEffect(function () {
    ...
    if (!q) return;
    setSeenFlags(function (p) {
      return p.find(function (s) {
        return s.flag.name === q.name;
      }) ? p : [].concat(_toConsumableArray(p), [{
        flag: q,
        result: null
      }]);
    });
    setOptions(shuffle([q].concat(_toConsumableArray(sample(flags.filter(function (f) {
  ...
  function handleAnswer(choice) {
    ...
    var q = questions[currentIndex];
    if (!q) return;
    var correct = choice.name === q.name;
    ...
    if (correct) {
      ...
      setFeedback("\xA1Incorrecto! La respuesta era ".concat(q.name, " \uD83D\uDE05"));
    }
    setSeenFlags(function (p) {
      return p.map(function (s) {
        return s.flag.name === q.name ? _objectSpread(_objectSpread({}, s), {}, {
  ...
  function nextQuestion() {
    if (currentIndex + 1 >= questions.length) {
      if (gameMode === "progressive") {
        endFase(phaseCorrects >= fases[faseIndex].minAciertos);
      } else setStage("end");
    } else setCurrentIndex(function (i) {
      return i + 1;
    });
  }
  function endFase(ok) {
  ...
  function saveScore(nombre) {
    ...
    var nuevo = [].concat(_toConsumableArray(ranking), [entry]).filter(function (r) {
      return r.nivel > 0;
    });
    nuevo.sort(function (a, b) {
      return b.score - a.score;
    });
    setRanking(nuevo.slice(0, 20));
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, stage === "game" && (questions[currentIndex] ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    ...
    src: "https://flagcdn.com/w320/".concat(questions[currentIndex].code, ".png"),
    alt: "",
    className: "w-64 h-40 object-cover rounded"
  })), /*#__PURE__*/React.createElement("div", {
    className: "hidden sm:block text-lg font-semibold mb-1"
    ...
    return /*#__PURE__*/React.createElement("button", {
      ...
      disabled: answered,
      className: "py-2 px-3 rounded-md text-base sm:text-lg font-semibold shadow bg-sky-100 hover:scale-105"
    }, opt.name);
  })), answered && gameMode !== "progressive" && /*#__PURE__*/React.createElement("div", {
    className: "mt-4 hidden sm:block"
  }, feedback))) : /*#__PURE__*/React.createElement("div", null, "Cargando...")), stage === "phaseTransition" && /*#__PURE__*/React.createElement("div", {
    ...
    highlightNext: true,
    className: "h-8 w-80"
  }))), stage === "ranking" && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    className: "flex justify-between mb-4"
  }, /*#__PURE__*/React.createElement("h2", {
    className: "text-2xl"
    ...
    className: "min-w-full text-left text-sm sm:text-base"
  }, /*#__PURE__*/React.createElement("thead", null, /*#__PURE__*/React.createElement("tr", null, /*#__PURE__*/React.createElement("th", null, "Nombre"), /*#__PURE__*/React.createElement("th", null, "Puntos"), /*#__PURE__*/React.createElement("th", null, "Nivel"), /*#__PURE__*/React.createElement("th", null, "Hitos"), /*#__PURE__*/React.createElement("th", null, "Fecha"))), /*#__PURE__*/React.createElement("tbody", null, ranking.sort(function (a, b) {
    return sortBy === "score" ? b.score - a.score : new Date(b.fechaISO) - new Date(a.fechaISO);
  }).map(function (r, i) {
    return /*#__PURE__*/React.createElement("tr", {
      key: i
    }, /*#__PURE__*/React.createElement("td", null, r.nombre), /*#__PURE__*/React.createElement("td", null, r.score), /*#__PURE__*/React.createElement("td", null, phraseForLevel(r.nivel)), /*#__PURE__*/React.createElement("td", null, /*#__PURE__*/React.createElement(SegmentedBar, {
      value: r.nivel,
      className: "h-4 w-32"
    })), /*#__PURE__*/React.createElement("td", null, formatDateShort(r.fechaISO)));
  })))))));
}
