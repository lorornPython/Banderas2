...
function App() {
  ...
  function handleAnswer(choice) {
    ...
    // añado LOR
    setChosen(choice.name); // 👈 NUEVO guardamos el país que pulsó
    setAnswered(true); // 👈 NUEVO marcamos respondido inmediatamente
    //añadido LOR
    if (correct) {
      if (gameMode === "progressive") {
        var puntos = 10;
    ...
    if (gameMode === "progressive") {
      // Avanza automáticamente tras 1 segundo
      setTimeout(function () {
        nextQuestion();
      }, 1000);
    }
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
      ...
      return /*#__PURE__*/React.createElement("button", {
        ...
        disabled: answered,
        className: "py-2 px-3 rounded-md text-base sm:text-lg font-semibold shadow transition transform hover:scale-105\n        ".concat(answered ? opt.name === current.name ? "bg-emerald-500 text-white" // ✅ la correcta en verde
        : opt.name === chosen ? "bg-red-500 text-white" // ❌ la fallada en rojo
        : "bg-slate-100 text-slate-600" // el resto en gris
    ...
    var _r$fase, _r$nivel, _r$nivel2;
    return /*#__PURE__*/React.createElement("tr", {
      key: i
    }, /*#__PURE__*/React.createElement("td", null, r.nombre), /*#__PURE__*/React.createElement("td", null, r.score), /*#__PURE__*/React.createElement("td", null, (_r$fase = r.fase) !== null && _r$fase !== void 0 ? _r$fase : "-"), /*#__PURE__*/React.createElement("td", null, (_r$nivel = r.nivel) !== null && _r$nivel !== void 0 ? _r$nivel : "-"), /*#__PURE__*/React.createElement("td", null, /*#__PURE__*/React.createElement("div", {
      className: "w-32 bg-slate-200 h-4 rounded overflow-hidden"
    }, /*#__PURE__*/React.createElement("div", {
      className: "h-full bg-gradient-to-r from-indigo-500 to-emerald-500",
      style: {
        width: "".concat(((_r$nivel2 = r.nivel) !== null && _r$nivel2 !== void 0 ? _r$nivel2 : 0) / 10 * 100, "%")
      }
