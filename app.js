...
function SegmentedBar(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement("div", {
      key: i,
      className: "flex-1 h-full rounded-sm ".concat(i < filled ? "bg-gradient-to-r from-indigo-500 to-emerald-500" : "bg-white/70")
    });
  })));
}
