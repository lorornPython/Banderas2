...
/*****************************************************************
 * DATA: lista de países (recortada aquí para abreviar)
 *****************************************************************/
var flags = [/* ... la lista completa de banderas ... */
...
function App() {
  ...
  }, stage === "game" && (questions[currentIndex] ? function () {
    var current = questions[currentIndex];
  ...
  }, "Cargando pregunta...")), stage === "ranking" && /*#__PURE__*/React.createElement("div", {
