...
var frasesNivel = {
  1: "¡Buen comienzo! 🚀",
  2: "Ya calientas motores 🔥",
  3: "Avance sólido 💪",
  4: "Foco y precisión 🎯",
  5: "Mitad del camino 👣",
  6: "Se nota el nivel ⚙️",
  7: "Élite en formación 💎",
  8: "¡Casi maestro! ⭐",
  9: "Pura leyenda ⚡",
  10: "¡Campeón absoluto! 🏆"
};
...
function SegmentedBar(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    if (i < filled) bg = levelColors[i % levelColors.length];else if (highlightNext && i === filled) bg = "#facc15"; // amarillo brillante para el siguiente segmento
    return /*#__PURE__*/React.createElement("div", {
      key: i,
      style: {
        backgroundColor: bg
...
function App() {
  ...
  // Estado general (filtros múltiples)
  ...
  // Progresivo (4 fases internas; barra general tiene 10 niveles para motivación/escala futura)
  var fases = [{
    dificultad: 1,
    numPreguntas: 5,
    minAciertos: 3,
  ...
  function saveScore(nombre) {
    // ❌ No registrar training en ranking
    if (gameMode === "classic") {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "P: ", /*#__PURE__*/React.createElement("strong", null, score), " | T: ", tiempoRestante, "s | ", currentIndex + 1, "/", questions.length)), gameMode === "progressive" && /*#__PURE__*/React.createElement(SegmentedBar, {
    ...
    className: "pr-4 py-2"
  }, "Motivaci\xF3n"), /*#__PURE__*/React.createElement("th", {
    className: "pr-4 py-2"
  }, "Progreso"), /*#__PURE__*/React.createElement("th", {
    className: "pr-4 py-2"
