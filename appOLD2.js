...
/*****************************************************************
 * DATA:
 * - Esta lista contiene 100 países reales (sin duplicados).
 * - Cada objeto: name, code (ISO2 minúsculas), capital, population (aprox),
 *   region, difficulty (1..4), hasBlue, hasRed, hasWhite, hasYellow, hasStars, hasStripes
 *
 * Si quieres añadir los 95 países restantes para llegar a 195, ver instrucciones finales.
 *****************************************************************/
var flags = [
// 🌍 EUROPA (44 países)
{
...
function App() {
  // stages: menu, start (config clásico), game, end, seen, ranking
  ...
  var fases = [{
    ...
    minAciertos: 3,
    tiempo: 30,
    desc: "Explorador Novato",
    msg: "Cada viaje comienza con el primer paso. ¡Demuéstralo!"
  }, {
    dificultad: 1,
    numPreguntas: 6,
    minAciertos: 4,
    tiempo: 28,
    desc: "Conquistador Curioso",
    msg: "Tu curiosidad te llevará lejos. ¡Sigue adelante!"
  }, {
    dificultad: 2,
    numPreguntas: 6,
    minAciertos: 5,
    tiempo: 26,
    desc: "Cartógrafo Aprendiz",
    msg: "Empiezas a trazar el mapa del mundo. ¡No te detengas!"
  }, {
    dificultad: 2,
    numPreguntas: 7,
    minAciertos: 5,
    tiempo: 24,
    desc: "Descubridor Valiente",
    msg: "La valentía abre caminos. ¡A por más banderas!"
  }, {
    dificultad: 2,
    numPreguntas: 7,
    minAciertos: 6,
    tiempo: 22,
    desc: "Explorador Avanzado",
    msg: "Ya no eres principiante: tu maestría crece."
  }, {
    dificultad: 3,
    numPreguntas: 8,
    minAciertos: 6,
    tiempo: 20,
    desc: "Navegante Experto",
    msg: "Navegas entre naciones como un experto. ¡Imparable!"
  }, {
    dificultad: 3,
    numPreguntas: 8,
    minAciertos: 7,
    tiempo: 18,
    desc: "Capitán de Banderas",
    msg: "El timón del conocimiento está en tus manos."
  }, {
    dificultad: 3,
    numPreguntas: 9,
    minAciertos: 8,
    tiempo: 16,
    desc: "Diplomático Global",
    msg: "Tu visión mundial inspira respeto. ¡Sigue construyendo puentes!"
  }, {
    dificultad: 4,
    numPreguntas: 9,
    minAciertos: 8,
    tiempo: 14,
    desc: "Estratega Mundial",
    msg: "Tu mente domina el juego. ¡La victoria está cerca!"
  }, {
    dificultad: 4,
    numPreguntas: 10,
    minAciertos: 9,
    tiempo: 12,
    desc: "Maestro de las Banderas",
    msg: "Has alcanzado la cima. ¡Eres una leyenda!"
  }];
  ...
  function filterPool() {
    var pool = flags.filter(function (f) {
      return f.difficulty === Number(difficulty);
    });
    if (region !== "Todos") pool = pool.filter(function (f) {
      return f.region === region;
    });
    if (feature !== "Todos") {
      if (feature === "Con Azul") pool = pool.filter(function (f) {
        return f.hasBlue;
      });
      if (feature === "Con Rojo") pool = pool.filter(function (f) {
        return f.hasRed;
      });
      if (feature === "Con Blanco") pool = pool.filter(function (f) {
        return f.hasWhite;
      });
      if (feature === "Con Amarillo") pool = pool.filter(function (f) {
        return f.hasYellow;
      });
      if (feature === "Con Estrellas") pool = pool.filter(function (f) {
        return f.hasStars;
      });
      if (feature === "Con Rayas") pool = pool.filter(function (f) {
        return f.hasStripes;
      });
    }
    return pool;
  ...
  function startGame() {
    ...
    var n = Math.min(numQuestions, pool.length);
  ...
  function iniciarFase(index) {
    ...
    // Configurar parámetros de la fase
    ...
    var t = setInterval(function () {
      setTiempoRestante(function (prev) {
        ...
        if (prev <= 1) {
          clearInterval(t);
          // Se agota el tiempo => no supera fase
          endFase(false);
          return 0;
        }
        return prev - 1;
  ...
  useEffect(function () {
    ...
    setSeenFlags(function (prev) {
      if (prev.find(function (p) {
        return p.flag.name === current.name;
      })) return prev;
    ...
    var otherPool = flags.filter(function (f) {
      return f.name !== current.name && (region === "Todos" || f.region === region);
    });
    var others = sample(otherPool, Math.min(5, otherPool.length));
    setOptions(shuffle([current].concat(_toConsumableArray(others))));
    setAnswered(false);
    setFeedback("");
  ...
  function handleAnswer(choice) {
    ...
    if (answered) return;
    var current = questions[currentIndex];
    var correct = choice.name === current.name;
    if (correct) {
      ...
      setFeedback("\xA1Incorrecto! La respuesta era ".concat(current.name, " \uD83D\uDE05"));
      setLastResult("wrong");
      try {
    ...
    setAnswered(true);
    // actualizar estado de seen
    setSeenFlags(function (prev) {
      return prev.map(function (s) {
        return s.flag.name === current.name ? _objectSpread(_objectSpread({}, s), {}, {
  ...
  function saveScore(nombre) {
    var _fases$faseIndex;
    var faseDesc = gameMode === "progressive" ? (_fases$faseIndex = fases[faseIndex]) === null || _fases$faseIndex === void 0 ? void 0 : _fases$faseIndex.desc : "Modo Clásico";
    var entrada = {
  ...
  if (lastResult === "correct") {
    fondo = "linear-gradient(135deg,#dbeafe,#3b82f6)";
  } else if (lastResult === "wrong") {
    fondo = "linear-gradient(135deg,#fee2e2,#ef4444)";
  } else {
    fondo = gameMode === "progressive" ? fondos[Math.min(faseIndex, fondos.length - 1)] : "linear-gradient(135deg,#eef2ff,#fde68a)";
  }
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "Modo Cl\xE1sico"), /*#__PURE__*/React.createElement("button", {
  ...
  }, "Modo Progresivo"), /*#__PURE__*/React.createElement("button", {
    onClick: function onClick() {
    ...
    className: "block text-sm mb-1"
  }, "Caracter\xEDsticas"), /*#__PURE__*/React.createElement("select", {
    value: feature,
    onChange: function onChange(e) {
      return setFeature(e.target.value);
    },
    className: "w-full p-2 rounded border"
  }, /*#__PURE__*/React.createElement("option", null, "Todos"), /*#__PURE__*/React.createElement("option", null, "Con Azul"), /*#__PURE__*/React.createElement("option", null, "Con Rojo"), /*#__PURE__*/React.createElement("option", null, "Con Blanco"), /*#__PURE__*/React.createElement("option", null, "Con Amarillo"), /*#__PURE__*/React.createElement("option", null, "Con Estrellas"), /*#__PURE__*/React.createElement("option", null, "Con Rayas")))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("button", {
    onClick: startGame,
    className: "px-6 py-3 bg-emerald-500 text-white rounded-2xl font-bold hover:scale-105 transition"
  }, "\xA1Empezar Juego!")), /*#__PURE__*/React.createElement("div", {
    className: "mt-3 text-sm text-slate-500"
  }, "Nota: la lista actual incluye ", /*#__PURE__*/React.createElement("strong", null, flags.length), " pa\xEDses. Puedes ajustar filtros si quieres menos/otros.")), stage === "game" && questions.length > 0 && function (_fases$faseIndex3, _fases$faseIndex4) {
    {
      var _fases$faseIndex2;
      gameMode === "progressive" && /*#__PURE__*/React.createElement("div", {
        className: "mb-4 text-center"
      }, /*#__PURE__*/React.createElement("div", {
        className: "text-xl font-bold"
      }, "Fase ", faseIndex + 1, "/10: ", (_fases$faseIndex2 = fases[faseIndex]) === null || _fases$faseIndex2 === void 0 ? void 0 : _fases$faseIndex2.desc));
    }
    var current = questions[currentIndex];
    return /*#__PURE__*/React.createElement("div", null, gameMode === "progressive" && /*#__PURE__*/React.createElement("div", {
      className: "mb-6 text-center"
    }, /*#__PURE__*/React.createElement("div", {
      className: "text-xl font-bold"
    }, "Fase ", faseIndex + 1, "/10: ", (_fases$faseIndex3 = fases[faseIndex]) === null || _fases$faseIndex3 === void 0 ? void 0 : _fases$faseIndex3.desc), /*#__PURE__*/React.createElement("div", {
      className: "text-md italic text-slate-600 mt-1"
    }, (_fases$faseIndex4 = fases[faseIndex]) === null || _fases$faseIndex4 === void 0 ? void 0 : _fases$faseIndex4.msg)), /*#__PURE__*/React.createElement("div", {
      className: "flex items-center justify-between mb-4"
    }, /*#__PURE__*/React.createElement("div", {
      className: "text-sm text-slate-600"
    }, "Puntuaci\xF3n: ", /*#__PURE__*/React.createElement("strong", null, score), " / ", currentIndex), gameMode === "progressive" && /*#__PURE__*/React.createElement("div", {
      className: "text-sm text-slate-600"
    }, "Tiempo: ", /*#__PURE__*/React.createElement("strong", null, tiempoRestante), "s"), /*#__PURE__*/React.createElement("div", {
      className: "text-sm text-slate-600"
    }, "Pregunta ", currentIndex + 1, " de ", questions.length)), /*#__PURE__*/React.createElement("div", {
      ...
      return /*#__PURE__*/React.createElement("button", {
        ...
        disabled: answered,
        className: "py-3 px-4 rounded-2xl font-medium shadow transition transform hover:scale-105\n                        ".concat(answered ? opt.name === current.name ? "bg-emerald-400 text-slate-900" : "bg-slate-100 text-slate-600" : "bg-sky-100 text-slate-800")
      }, opt.name);
      ...
      className: "px-6 py-2 bg-indigo-500 text-white rounded-2xl font-bold hover:scale-105 transition"
    }, currentIndex + 1 === questions.length ? gameMode === "progressive" ? "Terminar fase" : "Ver resultado" : "Siguiente pregunta")))));
  ...
  }, /*#__PURE__*/React.createElement("thead", null, /*#__PURE__*/React.createElement("tr", null, /*#__PURE__*/React.createElement("th", null, "Nombre"), /*#__PURE__*/React.createElement("th", null, "Puntos"), /*#__PURE__*/React.createElement("th", null, "Fase"), /*#__PURE__*/React.createElement("th", null, "Fecha"))), /*#__PURE__*/React.createElement("tbody", null, ranking.map(function (r, i) {
    return /*#__PURE__*/React.createElement("tr", {
      key: i
    }, /*#__PURE__*/React.createElement("td", null, r.nombre), /*#__PURE__*/React.createElement("td", null, r.score), /*#__PURE__*/React.createElement("td", null, r.fase), /*#__PURE__*/React.createElement("td", null, r.fecha));
  }))), /*#__PURE__*/React.createElement("button", {
    onClick: function onClick() {
...
function SeenView(_ref) {
  ...
  useEffect(function () {
    // sync allExpanded -> expanded
    if (allExpanded) {
      var newExp = {};
      seen.forEach(function (s) {
        return newExp[s.flag.name] = true;
      });
      setExpanded(newExp);
    } else {
      // collapse all
